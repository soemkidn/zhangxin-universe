package com.zhangxin.zhangxinuniverse.service.impl;
...
import com.zhangxin.zhangxinuniverse.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String planetCode) {
        ...
        if (planetCode.length() > 5) {
            throw new BusinessException(StatusCode.PARAMS_ERROR, "星球编号过长");
        }
        // 账户不能包含特殊字符
        String validPattern = "[`~!@#$%^&*()+=|{}':;',\\\\[\\\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]";
        ...
        if (count > 0) {
            throw new BusinessException(StatusCode.PARAMS_ERROR, "编号重复");
        }
        // 2. 加密
